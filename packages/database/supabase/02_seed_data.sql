...
('a1000001-0000-0000-0000-000000000001', 'Bandalungwa', 'Zone de Santé de Bandalungwa', 'Bandalungwa', 245000, 18, -4.3333, 15.3167),
('a1000001-0000-0000-0000-000000000002', 'Barumbu', 'Zone de Santé de Barumbu-Kinshasa', 'Barumbu', 185000, 12, -4.3125, 15.3042),
('a1000001-0000-0000-0000-000000000003', 'Binza-Météo', 'Zone de Santé de Binza-Météo', 'Ngaliema', 320000, 22, -4.3800, 15.2400),
('a1000001-0000-0000-0000-000000000004', 'Binza-Ozone', 'Zone de Santé de Binza-Ozone', 'Ngaliema', 280000, 20, -4.3600, 15.2500),
('a1000001-0000-0000-0000-000000000005', 'Biyela', 'Zone de Santé de Biyela', 'Nsele', 150000, 15, -4.3200, 15.5800),
('a1000001-0000-0000-0000-000000000006', 'Bumbu', 'Zone de Santé de Bumbu', 'Bumbu', 380000, 25, -4.3583, 15.2917),
('a1000001-0000-0000-0000-000000000007', 'Gombe', 'Zone de Santé de Gombe', 'Gombe', 95000, 8, -4.3000, 15.2833),
('a1000001-0000-0000-0000-000000000008', 'Kalamu I', 'Zone de Santé de Kalamu I', 'Kalamu', 185000, 14, -4.3550, 15.3050),
('a1000001-0000-0000-0000-000000000009', 'Kalamu II', 'Zone de Santé de Kalamu II', 'Kalamu', 175000, 13, -4.3620, 15.3120),
('a1000001-0000-0000-0000-000000000010', 'Kasa-Vubu', 'Zone de Santé de Kasa-Vubu', 'Kasa-Vubu', 165000, 12, -4.3417, 15.3083),
('a1000001-0000-0000-0000-000000000011', 'Kikimi', 'Zone de Santé de Kikimi', 'Nsele', 95000, 10, -4.2800, 15.6200),
('a1000001-0000-0000-0000-000000000012', 'Kimbanseke', 'Zone de Santé de Kimbanseke', 'Kimbanseke', 580000, 35, -4.4333, 15.4000),
('a1000001-0000-0000-0000-000000000013', 'Kingabwa', 'Zone de Santé de Kingabwa', 'Limete', 420000, 28, -4.3900, 15.3600),
('a1000001-0000-0000-0000-000000000014', 'Kingasani', 'Zone de Santé de Kingasani', 'Kimbanseke', 450000, 30, -4.4200, 15.4200),
('a1000001-0000-0000-0000-000000000015', 'Kinshasa', 'Zone de Santé de Kinshasa-Centre', 'Kinshasa', 145000, 10, -4.3256, 15.3136),
('a1000001-0000-0000-0000-000000000016', 'Kintambo', 'Zone de Santé de Kintambo', 'Kintambo', 195000, 15, -4.3167, 15.2667),
('a1000001-0000-0000-0000-000000000017', 'Kisenso', 'Zone de Santé de Kisenso', 'Kisenso', 520000, 32, -4.4167, 15.3417),
('a1000001-0000-0000-0000-000000000018', 'Lemba', 'Zone de Santé de Lemba', 'Lemba', 380000, 24, -4.4167, 15.3083),
('a1000001-0000-0000-0000-000000000019', 'Limete', 'Zone de Santé de Limete', 'Limete', 285000, 20, -4.3833, 15.3500),
('a1000001-0000-0000-0000-000000000020', 'Lingwala', 'Zone de Santé de Lingwala', 'Lingwala', 125000, 9, -4.3208, 15.2958),
('a1000001-0000-0000-0000-000000000021', 'Makala', 'Zone de Santé de Makala', 'Makala', 420000, 28, -4.3917, 15.3083),
('a1000001-0000-0000-0000-000000000022', 'Maluku I', 'Zone de Santé de Maluku I', 'Maluku', 85000, 12, -4.0500, 15.8000),
('a1000001-0000-0000-0000-000000000023', 'Maluku II', 'Zone de Santé de Maluku II', 'Maluku', 75000, 10, -4.1200, 15.8800),
('a1000001-0000-0000-0000-000000000024', 'Masina I', 'Zone de Santé de Masina I', 'Masina', 480000, 30, -4.3750, 15.3950),
('a1000001-0000-0000-0000-000000000025', 'Masina II', 'Zone de Santé de Masina II', 'Masina', 520000, 32, -4.3920, 15.4100),
('a1000001-0000-0000-0000-000000000026', 'Matete', 'Zone de Santé de Matete', 'Matete', 340000, 22, -4.3750, 15.3250),
('a1000001-0000-0000-0000-000000000027', 'Mont-Ngafula I', 'Zone de Santé de Mont-Ngafula I', 'Mont-Ngafula', 185000, 18, -4.4400, 15.2100),
('a1000001-0000-0000-0000-000000000028', 'Mont-Ngafula II', 'Zone de Santé de Mont-Ngafula II', 'Mont-Ngafula', 165000, 16, -4.4600, 15.2300),
('a1000001-0000-0000-0000-000000000029', 'Ndjili', 'Zone de Santé de Ndjili', 'Ndjili', 620000, 38, -4.3917, 15.4333),
('a1000001-0000-0000-0000-000000000030', 'Ngaba', 'Zone de Santé de Ngaba', 'Ngaba', 195000, 14, -4.3917, 15.3167),
('a1000001-0000-0000-0000-000000000031', 'Ngiri-Ngiri', 'Zone de Santé de Ngiri-Ngiri', 'Ngiri-Ngiri', 245000, 17, -4.3500, 15.3000),
('a1000001-0000-0000-0000-000000000032', 'Police', 'Zone de Santé de la Police', 'Gombe', 45000, 5, -4.3100, 15.2900),
('a1000001-0000-0000-0000-000000000033', 'Selembao', 'Zone de Santé de Selembao', 'Selembao', 420000, 26, -4.3917, 15.2583),
('a1000001-0000-0000-0000-000000000034', 'Camp Luka', 'Zone de Santé de Camp Luka', 'Ngaliema', 55000, 6, -4.3400, 15.2200),
('a1000001-0000-0000-0000-000000000035', 'Kokolo', 'Zone de Santé Militaire de Kokolo', 'Lingwala', 35000, 4, -4.3250, 15.2850)
ON CONFLICT (name) DO UPDATE SET 
    description = EXCLUDED.description,
